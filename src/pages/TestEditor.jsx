      ...
      <div className="w-full max-w-2xl">
        ...
        {activeTab === "layout" && (
          <div className="grid gap-4">
            ...
            <label>Box-Stil:<select className="w-full p-2 border" value={stylePreset} onChange={(e) => setStylePreset(e.target.value)}><option value="classic">Classic Shadow</option><option value="glass">Glass Look</option><option value="flat">Minimal Flat</option></select></label>
